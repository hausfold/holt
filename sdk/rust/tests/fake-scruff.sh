...
# lifecycle and error mapping can be exercised without a Go build. Shared
# verbatim with sdk/ts, sdk/python, sdk/swift and sdk/go's fixture of the
# same name; keep them in sync if the wire protocol changes.
set -euo pipefail
